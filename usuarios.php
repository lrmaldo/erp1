 ...
 var parametros = $(this).serialize();
  ...
  event.preventDefault();
	...
	function obtener_datos(id) {
			...
			var pasw_mail = $("#pasw_mail"+id).val();
			var mail_alterno = $("#mail_alterno"+id).val();
			var type_user = $("#type_user"+id).val();
			...
			$("#pasw_mail").val(pasw_mail);
			$("#edit_mail_alt").val(mail_alterno);
			$("#mod_type_user").val(type_user);
		}
</script>